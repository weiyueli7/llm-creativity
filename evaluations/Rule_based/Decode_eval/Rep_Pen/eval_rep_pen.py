                ...
                if isinstance(data, list):
                    for agent_idx, item in enumerate(data, start=1):
                        if isinstance(item, dict):
                            ...
                            Score = item.get("repetition_penalty")
...
if __name__ == "__main__":
    ...
    base_path_temp = "./Results/Decoding/Rep_Pen"
    ...
    file_name = "./Evaluation/Rule_based/Decode_eval/Statistics_Rep_Pen.json"
