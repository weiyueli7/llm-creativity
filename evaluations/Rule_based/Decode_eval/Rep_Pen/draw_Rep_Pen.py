...
file_path = "./Evaluation/Rule_based/Decode_eval/Statistics_Rep_Pen.json"
...
for category, entries in data.items():
    for entry in entries:
        top_k = entry["repetition_penalty"]
        rescaled_metrics = {
...
plt.title("Mean Scores by repetition_penalty", fontsize=20, fontweight='bold')
plt.xlabel("Repetition_penalty", fontsize=16, fontweight='bold')
