...
file_path = "./Evaluation/Rule_based/Decode_eval/Statistics_top_k.json"
...
plt.title("Mean Scores by top_k", fontsize=20, fontweight='bold')
plt.xlabel("Top_k", fontsize=16, fontweight='bold')
