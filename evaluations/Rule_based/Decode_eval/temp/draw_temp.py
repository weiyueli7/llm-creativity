...
file_path = "./Evaluation/Rule_based/Decode_eval/Statistics_temp.json"
...
plt.title("Mean Scores by temperature", fontsize=20, fontweight='bold')
plt.xlabel("Temperature", fontsize=16, fontweight='bold')
